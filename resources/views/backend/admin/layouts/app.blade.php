...
<html>
  <head> 
    ...
    <!-- theme stylesheet-->
    <link rel="stylesheet" href="{{ asset('backend/css/style.blue.css') }}" id="theme-stylesheet">
  ...
  <body>
    <header class="header">  
      <!-- Top Navigation--> 
      @include('backend.admin.layouts.navigation-top')
    </header>
    <div class="d-flex align-items-stretch">
      <!-- Sidebar Navigation-->
      @include('backend.admin.layouts.navigation-sidebar')
