...
<html>
  <head> 
    ...
    <!-- theme stylesheet-->
    <link rel="stylesheet" href="{{ asset('backend/css/style.pink.css') }}" id="theme-stylesheet">
  ...
  <body>
    <header class="header">  
      <!-- Top Navigation--> 
      @include('backend.trainee.layouts.navigation-top')
    </header>
    <div class="d-flex align-items-stretch">
      <!-- Sidebar Navigation-->
      @include('backend.trainee.layouts.navigation-sidebar')
      <!-- Sidebar Navigation end-->
      <div class="page-content">
        @yield('content')
        @include('backend.trainee.layouts.footer')
      </div>
    </div>
    <!-- JavaScript files-->
    <script>
