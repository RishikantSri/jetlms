            ...
            <div class="row">
                <div class="col-6">
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <input type="text" class="form-control" id="sitetitie" name="sitetitle" value=" {{ $sitesetting->sitetitle }}">
                            @error('sitetitle')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <input type="text" class="form-control" id="sec_cour_headind" name="heading" value=" {{ $sitesetting->heading }}">
                            @error('heading')
                            <div class="alert alert-danger" ><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <input type="text" class="form-control" id="sec_cour_headind" name="sub_heading" value=" {{ $sitesetting->sub_heading }}">
                            @error('sub_heading')
                            <div class="alert alert-danger" ><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <input type="text" class="form-control" id="sec_cour_des" name="button_text" value="{{ $sitesetting->button_text }}">
                            @error('button_text')
                            <div class="alert alert-danger" ><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>{{ $message }}</div>
                            @enderror
                        </div>
